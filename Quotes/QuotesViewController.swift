...
//  Quotes
//
//  Created by Lena Sabadina on 2019-09-18.
...
class QuotesViewController: UITableViewController, SKPaymentTransactionObserver {
    ...
    let productID = "se.whiskerz.Quotes.PremiumQuotes"
    var quotesToShow = [
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row < quotesToShow.count {
            ...
            cell.textLabel?.textColor = #colorLiteral(red: 0, green: 0.445599556, blue: 0.9981841445, alpha: 1)
